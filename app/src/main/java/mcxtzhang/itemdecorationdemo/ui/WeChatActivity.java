...
public class WeChatActivity extends AppCompatActivity {
    ...
    private static final String INDEX_TAG_TOP = "↑";
    ...
    private void initDatas(final String[] data) {
        ...
        getWindow().getDecorView().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                mDatas.add((CityBean) new CityBean("新的朋友").setTop(true).setBaseIndexTag(INDEX_TAG_TOP));
                mDatas.add((CityBean) new CityBean("群聊").setTop(true).setBaseIndexTag(INDEX_TAG_TOP));
                mDatas.add((CityBean) new CityBean("标签").setTop(true).setBaseIndexTag(INDEX_TAG_TOP));
                mDatas.add((CityBean) new CityBean("公众号").setTop(true).setBaseIndexTag(INDEX_TAG_TOP));
                for (String aName : data) {
                    CityBean cityBean = new CityBean();
                    cityBean.setCity(aName);// 设置城市名称
                    mDatas.add(cityBean);
                }
